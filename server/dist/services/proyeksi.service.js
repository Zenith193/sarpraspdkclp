...
export const proyeksiService = {
    ...
    async getRekap() {
        ...
        allSarpras.forEach(sp => {
            ...
            if (sp.jenisPrasarana === 'Ruang Kelas')
                sk.jmlRuangKelas++;
            if (sp.jenisPrasarana === 'Toilet')
                sk.jmlToilet++;
