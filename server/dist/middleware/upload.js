...
import fs from 'fs';
import os from 'os';
import { ensureDir, getSarprasFotoPath, getProposalPath, getBastPath, getKerusakanPath, getPrestasiPath, getKopSekolahPath, getTemplatePath } from '../utils/storagePaths';
import { uploadToNas } from '../utils/nasClient';
 ...
 */
export function forwardToNas(category) {
 ...
 */
function getLocalDestination(category, body) {
    const sekolah = (body.kecamatan && body.namaSekolah && body.npsn)
        ? { kecamatan: body.kecamatan, nama: body.namaSekolah, npsn: body.npsn }
        : null;
    if (sekolah) {
