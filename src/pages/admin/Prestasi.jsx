                    ...
                    <div className="modal" style={{ maxWidth: 600 }} onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-body">
                            ...
                            <div className="form-row">
                                <div className="form-group"><label className="form-label" style={{ fontSize: '0.875rem' }}>Jenis Prestasi</label><input className="form-input" list="prestasi-suggestions" value={formData.jenisPrestasi} onChange={e => setFormData({ ...formData, jenisPrestasi: e.target.value })} placeholder="Pilih atau ketik jenis prestasi" /><datalist id="prestasi-suggestions">{['Lomba Catur Tingkat Kabupaten', 'Lomba Catur Tingkat Kecamatan', 'Lomba Membaca', 'Lomba Menulis', 'Lomba Pidato', 'Lomba MTQ', 'Lomba Hafalan Al-Quran', 'Lomba Matematika', 'Lomba Sains', 'Lomba Bahasa Inggris', 'Lomba Mewarnai', 'Lomba Menggambar', 'Lomba Melukis', 'Lomba Puisi', 'Lomba Pantomim', 'Lomba Tari', 'Lomba Drumband', 'Lomba Pramuka', 'Lomba Sepak Bola', 'Lomba Bulu Tangkis', 'Lomba Atletik', 'Lomba Renang', 'Lomba Voli', 'Lomba Tenis Meja', 'Lomba Pencak Silat', 'Olimpiade Sains Nasional (OSN)', 'Festival Lomba Seni Siswa Nasional (FLS2N)', 'O2SN', 'Lomba Robotik', 'Lomba Cerdas Cermat'].map(s => <option key={s} value={s} />)}</datalist></div>
                                <div className="form-group"><label className="form-label" style={{ fontSize: '0.875rem' }}>Siswa/Tim</label><input className="form-input" list="siswa-suggestions" value={formData.siswa} onChange={e => setFormData({ ...formData, siswa: e.target.value })} placeholder="Nama siswa atau tim" /><datalist id="siswa-suggestions">{['Tim Garuda', 'Tim Elang', 'Tim Rajawali', 'Tim Cendrawasih', 'Tim Merah Putih', 'Tim Bintang', 'Kartika Dwi', 'Ahmad Fauzi', 'Siti Nurhaliza', 'Budi Santoso', 'Dewi Sartika', 'Rizki Pratama', 'Anisa Rahma', 'Bayu Aditya'].map(s => <option key={s} value={s} />)}</datalist></div>
                            </div>
                            <div className="form-row">
