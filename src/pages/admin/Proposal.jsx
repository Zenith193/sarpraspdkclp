    ...
    const handlePrintChecklist = () => {
        ...
        const verSection = checklistForm.verifikators.length > 0
            ? checklistForm.verifikators.map(v =>
                `<div style="text-align:left;margin-top:80px;min-width:300px"><div style="font-size:12pt">Cilacap, ${tanggal}</div><div style="font-size:12pt;margin-top:4px">Verifikator</div><div style="height:100px"></div><div style="text-decoration:underline;font-weight:bold;font-size:14pt">${v.nama || '...........................'}</div><div style="font-size:12pt;margin-top:4px">NIP. ${v.nip || '...........................'}</div></div>`
            ).join('')
            : `<div style="text-align:left;margin-top:80px;min-width:300px"><div style="font-size:12pt">Cilacap, ${tanggal}</div><div style="font-size:12pt;margin-top:4px">Verifikator</div><div style="height:100px"></div><div style="text-decoration:underline;font-weight:bold;font-size:14pt">.............................</div><div style="font-size:12pt;margin-top:4px">NIP. .............................</div></div>`;
