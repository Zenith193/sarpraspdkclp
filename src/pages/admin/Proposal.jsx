    ...
    const handlePrintChecklist = () => {
        ...
        const verSection = checklistForm.verifikators.length > 0
            ? checklistForm.verifikators.map(v =>
                `<div style="text-align:left;margin-top:10px;min-width:300px"><div style="font-size:12pt">Cilacap, ${tanggal}</div><div style="font-size:12pt;margin-top:4px">Verifikator</div><div style="height:50px"></div><div style="text-decoration:underline;font-weight:bold;font-size:12pt">${v.nama || '...........................'}</div><div style="font-size:12pt;margin-top:4px">NIP. ${v.nip || '...........................'}</div></div>`
            ).join('')
            : `<div style="text-align:left;margin-top:10px;min-width:300px"><div style="font-size:12pt">Cilacap, ${tanggal}</div><div style="font-size:12pt;margin-top:4px">Verifikator</div><div style="height:50px"></div><div style="text-decoration:underline;font-weight:bold;font-size:12pt">.............................</div><div style="font-size:12pt;margin-top:4px">NIP. .............................</div></div>`;
        ...
        <table><thead><tr><th rowspan="2" style="width:30px;font-size:12pt">NO</th><th rowspan="2" style="font-size:12pt">INDIKATOR / URAIAN</th><th colspan="2" style="font-size:12pt">HASIL</th><th rowspan="2" style="font-size:12pt">KETERANGAN</th></tr><tr><th style="width:60px;font-size:12pt">ADA</th><th style="width:60px;font-size:12pt">TIDAK ADA</th></tr></thead><tbody>${rows}</tbody></table>
        <div style="margin-top:12px;font-size:12pt"><p><b>Kesimpulan / Catatan :</b></p><p>1. ............................................................................................................</p><p>2. ............................................................................................................</p><p>dst.</p></div>
