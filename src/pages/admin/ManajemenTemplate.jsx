...
const GUIDE_DATA = {
    "Identitas Paket": [
        ...
        { variable: "{{npsn}}", description: "NPSN" },
        { variable: "{{sumberDana}}", description: "Sumber dana" },
        ...
        { variable: "{{subBidang}}", description: "Sub bidang" },
        { variable: "{{noSubKegiatan}}", description: "Nomor sub kegiatan" },
        { variable: "{{subKegiatan}}", description: "Nama sub kegiatan" },
        { variable: "{{rup}}", description: "RUP" },
    ],
    "Keuangan": [
        { variable: "{{nilaiKontrak}}", description: "Nilai kontrak (Rp format)" },
        { variable: "{{nilaiKontrakRaw}}", description: "Nilai kontrak (angka)" },
        { variable: "{{terbilangKontrak}}", description: "Terbilang nilai kontrak" },
        { variable: "{{paguAnggaran}}", description: "Pagu anggaran" },
        { variable: "{{paguPaket}}", description: "Pagu paket" },
        { variable: "{{hps}}", description: "HPS" },
        { variable: "{{honor}}", description: "Honor pelaksana" },
    ],
    "Penyedia": [
        { variable: "{{penyedia}}", description: "Nama penyedia" },
        { variable: "{{namaPemilik}}", description: "Nama pemilik/direktur" },
        { variable: "{{statusPemilik}}", description: "Status pemilik" },
        { variable: "{{alamatKantor}}", description: "Alamat kantor penyedia" },
        { variable: "{{npwpPenyedia}}", description: "NPWP penyedia" },
        { variable: "{{noRekPenyedia}}", description: "Nomor rekening penyedia" },
        { variable: "{{bankPenyedia}}", description: "Bank penyedia" },
    ],
    "SPK & Kontrak": [
        { variable: "{{noSpk}}", description: "Nomor SPK" },
        { variable: "{{jangkaWaktu}}", description: "Jangka waktu (hari)" },
        { variable: "{{jangkaWaktuText}}", description: "Jangka waktu (teks)" },
    ],
    "Tanggal": [
        { variable: "{{tanggalMulai}}", description: "Tanggal mulai (DD-MM-YYYY)" },
        { variable: "{{hariTanggalMulai}}", description: "Hari, tgl bulan tahun mulai" },
        { variable: "{{terbilangTanggalMulai}}", description: "Terbilang tanggal mulai" },
        { variable: "{{tanggalSelesai}}", description: "Tanggal selesai (DD-MM-YYYY)" },
        { variable: "{{hariTanggalSelesai}}", description: "Hari, tgl bulan tahun selesai" },
        { variable: "{{terbilangTanggalSelesai}}", description: "Terbilang tanggal selesai" },
        { variable: "{{tglPcm}}", description: "Tanggal PCM" },
        { variable: "{{hariTanggalPcm}}", description: "Hari, tgl bulan tahun PCM" },
        { variable: "{{tglMc0}}", description: "Tanggal MC-0%" },
        { variable: "{{hariTanggalMc0}}", description: "Hari, tgl bulan tahun MC-0%" },
        { variable: "{{tglMc100}}", description: "Tanggal MC-100%" },
        { variable: "{{hariTanggalMc100}}", description: "Hari, tgl bulan tahun MC-100%" },
    ],
    "Pejabat": [
    ...
    "BAST": [
        { variable: "{{noBAST}}", description: "Nomor BAST (400.3.13/063.n/A3/2026)" },
    ...
    "Anakan": [
        ...
        { variable: "{{anakan1NilaiBAST}}", description: "Nilai BAST anakan ke-1" },
    ...
    "Utilitas": [
        { variable: "{{tahunTerbilang}}", description: "Tahun terbilang" },
        { variable: "{{dot}}", description: "Titik-titik ........" },
        { variable: "{{dotPanjang}}", description: "Titik-titik panjang" },
    ],
};
