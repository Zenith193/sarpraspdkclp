                                    ...
                                    <div style={{ overflowX: 'auto' }}>
                                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.78rem' }}>
                                            ...
                                            {[
                                                ...
                                                ['{{bank}}', 'Nama Bank', 'Bank Jateng Cabang Cilacap'],
                                                ['{{noRekening}}', 'No Rekening', '0035123456789'],
                                                ['{{namaRekening}}', 'Nama Pemilik Rekening', 'CV. JAGAT ALIT PERSADA'],
                                                ['{{emailPerusahaan}}', 'Email Perusahaan', 'jagatalitp@gmail.com'],
                                                ['TANGGAL MULAI', '', ''],
