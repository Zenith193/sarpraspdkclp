...
export function getAvailableVariables() {
    return [
        ...
        { group: 'BAST', vars: [
            ...
            { name: 'volume', desc: 'Volume pekerjaan' },
            { name: 'nilaiBAST', desc: 'Nilai BAST (Rp format)' },
            { name: 'nilaiBastRaw', desc: 'Nilai BAST (angka)' },
            { name: 'terbilangBAST', desc: 'Terbilang nilai BAST' },
        ]},
        { group: 'Anakan (Sub Paket)', vars: [
            { name: 'jumlahAnakan', desc: 'Jumlah anakan (angka)' },
            { name: 'anakan1NoBAST', desc: 'Nomor BAST anakan ke-1' },
            ...
            { name: 'anakan1Volume', desc: 'Volume anakan ke-1' },
            { name: 'anakan1NilaiBAST', desc: 'Nilai BAST anakan ke-1 (Rp format)' },
            { name: 'anakan1TerbilangBAST', desc: 'Terbilang nilai BAST anakan ke-1' },
        ...
        { group: 'Anakan 2-15 (pola sama)', vars: [
            { name: 'anakan2NoBAST', desc: 'Nomor BAST anakan ke-2 (dst sampai 15)' },
            { name: 'anakan2NamaSekolah', desc: 'Nama Sekolah anakan ke-2' },
            { name: 'anakan2Kepsek', desc: 'Kepala Sekolah anakan ke-2' },
            { name: 'anakan2NipKs', desc: 'NIP KS anakan ke-2' },
            { name: 'anakan2NamaPaket', desc: 'Nama Paket anakan ke-2' },
            { name: 'anakan2Volume', desc: 'Volume anakan ke-2' },
            { name: 'anakan2NilaiBAST', desc: 'Nilai BAST anakan ke-2' },
            { name: 'anakan2TerbilangBAST', desc: 'Terbilang anakan ke-2' },
