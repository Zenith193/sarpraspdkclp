...
export function getAvailableVariables() {
    return [
        { group: 'Data Matrik', vars: [
            ...
            { name: 'tanggalMulai', desc: 'Tanggal Mulai Kontrak' },
            { name: 'tanggalSelesai', desc: 'Tanggal Selesai Kontrak' },
        ]},
        { group: 'Data SPL/PCM/MC', vars: [
            { name: 'noPcm', desc: 'Nomor PCM' },
            { name: 'tglPcm', desc: 'Tanggal PCM' },
            { name: 'noMc0', desc: 'Nomor MC-0' },
            { name: 'tglMc0', desc: 'Tanggal MC-0' },
            { name: 'noMc100', desc: 'Nomor MC-100' },
            { name: 'tglMc100', desc: 'Tanggal MC-100' },
